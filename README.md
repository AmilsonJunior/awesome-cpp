...
* [SFML](http://www.sfml-dev.org/index.php) - SFML is a simple, fast, cross-platform and object-oriented multimedia API. It provides access to windowing, graphics, audio and network. [zlib/png]
